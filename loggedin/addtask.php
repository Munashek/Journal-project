                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Title"><b>Task Title</b></label>
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Title" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="details"><b>Details</b></label>
                                           <input type="text" id="details" name="details" placeholder="details" class="span8" required>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="date" name="date" placeholder="date" class="span8" required>
                                            </div>
                                        </div>
...
$sql1="insert into task (date,details,task) values ('$title','$details','$date')";
